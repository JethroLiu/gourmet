...
class HomeService extends Service {
    ...
    //advice 健康 烘焙 为您推荐
    async advice() {
        var res = await this.app.mysql.query(" select  image,wordsone,wordstwo,wordsthree,wordsfour,wordsfive,wordssix from advise")
        var arr = [];
...
>>>>>>> 105e69db44258160a797aa144dcb25567a6f4acf
    }

    //话题
    async topic() {
        var data = await this.app.mysql.query("select t.*,m.userPic,m.userName from topic t,myuser m where m.id=t.userId")
        return data;
    }
}
